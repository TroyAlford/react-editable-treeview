    ...
    value: function renderNodeList(nodes) {
      ...
      return React.createElement(
        ...
        nodes.map(function (node, index) {
          ...
          return contains(_this2.props.editing, node) ? _this2.props.editModeRenderer.call(_this2, node, props) : _this2.props.viewModeRenderer.call(_this2, node, props);
        })
      );
    }
  }, {
...
TreeView.defaultProps = {
  ...
  onNodeClick: function onNodeClick(node) {}, // eslint-disable-line no-unused-vars
